  ...
  <footer class="main-footer">
   ...
   <!--data table-->
  <link rel="stylesheet" href="<?= base_url();?>assets/datatables/DataTables-1.10.12/css/dataTables.bootstrap.min.css">
  <!-- daterange picker -->
  <link rel="stylesheet" href="<?= base_url();?>assets/plugins/daterangepicker/daterangepicker-bs3.css">
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?= base_url();?>assets/bootstrap-datepicker/css/bootstrap-datepicker3.min.css">

  <link rel="stylesheet" type="text/css" href="<?= base_url();?>assets/datatables/select-1.2.0/css/select.datatables.min.css"/>
  ...
  <script src="<?= base_url();?>assets/DataTables/select-1.2.0/js/datatables.select.min.js"></script>
  <!-- Morris.js charts -->
